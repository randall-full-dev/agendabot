...
function promptSistema(ctx) {
  return [
    ...
    '- Cuando "el proximo/siguiente <dia>" cae manana o pasado manana, ademas de',
    "  bajar la confianza hay que PREGUNTAR. Mucha gente lo usa para el de la semana",
    '  que entra: si quisiera el de manana diria "el miercoles" o "manana", sin',
    '  "proximo". Resuelvelo al mas cercano y pon en notas la pregunta nombrando LAS',
    '  DOS fechas. Un martes: "¿El miércoles de mañana, 23, o el siguiente, 30?"',
